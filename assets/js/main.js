...
const translations = {
  th: {
    ...
    'pillars.title': 'เครื่องเดียว<br/><span class="hl">เหมาะกับทุกเป้าหมาย</span>',
    ...
    'analysis.posture':     'สรีระท่าทาง — ประเมินความสมดุลของร่างกาย และแนะนำเกี่ยวกับท่าทางที่ถูกต้อง',
    ...
    'analysis.posture':     'สรีระท่าทาง — ประเมินความสมดุลและแนะนำท่าทางที่ถูกต้อง',
    ...
    'cta.eyebrow':   'สำหรับธุรกิจและองค์กรทุกประเภท',
    'cta.title':     'ค้นพบศักยภาพที่ซ่อนอยู่<br/><span class="hl">ได้แล้ววันนี้</span>',
    'cta.btn':       'ลงทะเบียนทดลอง',
    'modal.eyebrow': 'ทดลองฟรีสำหรับธุรกิจ',
    'modal.title':   'ลงทะเบียนทดลอง',
    'modal.subtitle':'สำหรับธุรกิจและองค์กรที่สนใจนำ OUTBODY ไปใช้งาน กรอกข้อมูลด้านล่าง ทีมงานจะติดต่อกลับภายใน 1 วันทำการ',
  ...
  en: {
    ...
    'cta.eyebrow':   'For Businesses & Organizations of All Kinds',
    'cta.title':     'Discover Your Hidden Potential<br/><span class="hl">Starting Today</span>',
    'cta.btn':       'Register for Trial',
    'modal.eyebrow': 'Free Trial for Businesses',
    'modal.title':   'Register for Trial',
    'modal.subtitle':'For businesses and organizations interested in OUTBODY. Fill in your details below and our team will contact you within 1 business day.',
    'modal.submit':  'Submit',
