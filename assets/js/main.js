...
const translations = {
  th: {
    ...
    'founder.bio':   'ก่อนจะมาเป็น OUTBODY ผู้ก่อตั้งของเราคือผู้เชี่ยวชาญด้านการฝึกร่างกายมากว่า 16 ปี ดูแลตั้งแต่ทีมรักษาความปลอดภัยระดับประธานาธิบดี ผู้บริหารองค์กร ไปจนถึงผู้ป่วยในโรงพยาบาล ประสบการณ์นี้คือรากฐานของ OUTBODY ร่วมกับการสนับสนุนจาก Hyundai Motor Group',
    'founder.title': 'ผู้ก่อตั้งและซีอีโอ OUTBODY',
    ...
    'age.card_unit':  'ปีที่อ่อนกว่าอายุจริง',
    'age.card_sub':   'ตัวอย่างผลตรวจ OUTBODY AGE',
  ...
  en: {
    ...
    'founder.bio':   'Before OUTBODY, our founder spent over 16 years as a physical training specialist — working with everyone from presidential security teams and corporate executives to hospital patients. That experience, backed by Hyundai Motor Group, is the foundation OUTBODY is built on.',
    'founder.title': 'Founder & CEO, OUTBODY',
    'age.label':      'OUTBODY AGE™',
    ...
    'age.card_unit':  'Years Younger Than Actual Age',
    'age.card_sub':   'Sample OUTBODY AGE Result',
